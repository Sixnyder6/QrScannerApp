...
- Файлы **>500 строк никогда не читать целиком** без явной команды.
- Для правки в одной функции: **сначала grep по имени → потом view нужный диапазон строк**.
...
- Не читай README/документацию без необходимости — там часто устаревшая инфа.
